...
{
    public class CreateUserCommandHandler : IRequestHandler<CreateUserCommand, ApiResponse<Token>>
    {
        private readonly FurnAppContext db;
        private readonly IConfiguration configuration;

        public CreateUserCommandHandler(FurnAppContext db, IConfiguration configuration)
        {
            this.db = db;
            this.configuration = configuration;
        }

        async Task<ApiResponse<Token>> IRequestHandler<CreateUserCommand, ApiResponse<Token>>.Handle(CreateUserCommand request, CancellationToken cancellationToken)
        {
