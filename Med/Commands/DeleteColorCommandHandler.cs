...
{
    public class DeleteColorCommandHandler : IRequestHandler<DeleteColorCommand, ApiResponse<Color>>
    {
        ...
        public async Task<ApiResponse<Color>> Handle(DeleteColorCommand request, CancellationToken cancellationToken)
        {
