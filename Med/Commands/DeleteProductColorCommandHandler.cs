...
{
    public class DeleteProductColorCommandHandler : IRequestHandler<DeleteProductColorCommand, ApiResponse<ProductColor>>
    {
        ...
        public async Task<ApiResponse<ProductColor>> Handle(DeleteProductColorCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                return new ApiResponse<ProductColor>()
                {
                    Data = null,
