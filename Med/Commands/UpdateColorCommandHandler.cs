...
{
    public class UpdateColorCommandHandler : IRequestHandler<UpdateColorCommand, ApiResponse<Color>>
    {
        ...
        public async Task<ApiResponse<Color>> Handle(UpdateColorCommand request, CancellationToken cancellationToken)
        {
